...
<head>
    ...
    <style>
        ...
        .form-container {
            width: 90%; /* Mengubah lebar menjadi lebih responsif */
            ...
            background-color: #CDEDFF; /* Warna latar belakang */
            border-radius: 20px;
        ...
        @media (max-width: 576px) {
            ...
            .card-price {
                font-size: 1.2rem; /* Ukuran font lebih kecil di ponsel */
            }

            .form-container {
                padding: 15px; /* Padding lebih kecil di ponsel */
            }
        }
    </style>
</head>
<body>
    ...
    <div>
        <div class="position-relative">
            ...
            <h1 class="card-title position-absolute" style="top: 0; left: 50%; transform: translateX(-50%); color: black; text-align: center; margin: 100px 0; font-size: 60px;">
    ...
    <div class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card recommendation-card">
                    <img src="imgs/jogja.jpg" class="card-img" alt="Yogyakarta">
                    <div class="card-img-overlay d-flex flex-column justify-content-end">
                        <p class="card-text">Flight from Jakarta <br>to</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card recommendation-card">
                    <img src="imgs/bajo.jpg" class="card-img" alt="Labuan Bajo">
                    <div class="card-img-overlay d-flex flex-column justify-content-end">
                        <p class="card-text">Flight from Jakarta <br>to</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card recommendation-card">
                    <img src="imgs/medan.jpg" class="card-img" alt="Medan">
                    <div class="card-img-overlay d-flex flex-column justify-content-end">
                        <p class="card-text">Flight from Jakarta <br>to</p>
